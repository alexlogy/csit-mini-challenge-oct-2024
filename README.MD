...
*For mac*
```bash
docker run -it -v /tmp/data:/data program_one:latest
```

*For Windows*
```bash
docker run -it -v ${pwd}/data:/data program_one:latest
```
...
*For mac*
```bash
docker run -it -v /tmp/data:/data program_two:latest
```

*For Windows*
```bash
docker run -it -v ${pwd}/data:/data program_two:latest
```
